...
prefixColor = "lightblue" -- options are: red, orange, yellow, lime, green, teal, lightblue, blue, darkblue, purple, pink, black, gray, or white
handleColor = "blue" -- sets color of Twitter handle when tweeting; options are: red, blue, yellow, green, or white
messageColor = "white" -- sets color of Twitter message; options are: red, blue, yellow, green, or white
...
embedFooter = ""  
embedColor = "" -- has to be deciaml, example: 3093151
